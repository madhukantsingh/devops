...
import GitConfigSlide from './GitConfigSlide';
import GitAuthSlide from './GitAuthSlide';
...
export default function SlideRenderer({ slide }: Props) {
  switch (slide.type) {
    ...
    case 'git-config': return <GitConfigSlide slide={slide} />;
    case 'git-auth': return <GitAuthSlide slide={slide} />;
    ...
    case 'git-history-revert': return <GitResetDetailsSlide slide={slide} />;
