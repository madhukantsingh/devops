...
const rawSlides: SlideData[] = [
  ...
  },
  {
    ...
    label: 'CORE',
    skipIfShortOnTime: false,
    takeaway: 'Changing a file, staging it, committing it, and pushing it are separate steps.',
    notes: [
      ...
      'Step 5: Click "git push" — travels to GitHub.',
    ],
    type: 'git-simulator',
  },
  {
  ...
  },
  {
    ...
    notes: [
      ...
      'PR shows: changed files, author, automated test results.',
      'The review process: comments, suggestions, approvals.',
    ],
  ...
  },
  {
    ...
    section: 'Git & Source Control',
    sectionNumber: 2,
    title: 'Undoing Changes: Soft vs Mixed vs Hard Reset',
    subtitle: 'Moving HEAD pointer back and managing working/staged files',
    duration: 4,
    optional: false,
    label: 'CORE',
    skipIfShortOnTime: false,
    takeaway: 'Soft reset keeps staged changes, Mixed reset unstages changes, Hard reset discards everything.',
    notes: [
      'git reset --soft HEAD~1: Moves HEAD, leaves changes staged.',
      'git reset --mixed HEAD~1: Moves HEAD, leaves changes unstaged in working directory.',
